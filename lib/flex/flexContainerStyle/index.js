...
const flexContainerStyle = (props) => {
     ...
     * justify-content
     */
    const justify = (0, getJustifyContent_1.getJustifyContent)(justifyContent);
    /**
     * align-content
     */
    const align = (0, getAlignContent_1.getAlignContent)(alignContent);
    /**
     * align-items
     */
    const items = (0, getAlignItems_1.getAlignItems)(alignItems);
